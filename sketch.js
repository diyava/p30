...
var ball;
var slingShot;
var polygon1_img,polygon1;
function preload(){
  polygon1_img=loadImage("polygon.png");
}
function setup() {
 ...
 slingShot = new Slingshot( this.polygon1,{x:200,y:100});
}
function draw() {
  background("white"); 
  ...
  block25.display();
 imageMode(CENTER)
 image(polygon1_img,polygon1.position.x,polygon1.position.y,40,40)
